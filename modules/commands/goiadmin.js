...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var tl = ["আমি এখন 𝐌𝐀𝐇𝐈𝐌 বস এর সাথে বিজি আছি🙆‍♀️🤷‍♀️", "what are you asking me to do?🥱🥱", "I love you baby meye hole chipay aso👩‍❤️‍👨", "Love you 3000-😍💋💝", "ji bolen ki korte pari ami apnar jonno?💞", "Ato daktasen kn bujhlam na 😡", "jan bal falaba,🙂","ask amr mon vlo nei dakben na🙂", "Hmm jan ummah😘😘","jang hanga korba 🙂🖤","iss ato dako keno prem korba naki  🫦🙈","suna tomare amar valo lage,🙈😽","জি তুমি কি আমাকে ডেকেছো 😇🖤🥀"," 𝗠𝗔𝗛𝗜𝗠 বস আর ভাবির সাথে বিজি আছি🙈🙊","Hi I am Robot made by 𝗠𝗔𝗛𝗜𝗠🤖😻💋", "Please don't disturb me🙊😾", "Love You janeman 😻💋❣️;*","Meri Jann Ki hoice? ❤️🧡","I Love uhh Always🖤💦","Baby bolo to kiss kori🥱😽","Jan tumi Sudu amar","Dating a cholo sona🙊🙈","Ami Naima Vabir sathe busy aci💋 " , "Bot bolo na sona janu bolo💘💔 " , "Bar Bar Disturb koro na ami busy aci 🤭🐒" , "tmr sathe kotha bolbo na 😉😝😋🤪" , "ato kace aso na valobeshe felbe💫💯" , "tumi amake valobasho tai na sona 🙈💋💋 " , "Are jaan Moja koro na to ami serious mood a aci😫" , "Bar Bar dakle valo hobe na kintu 🤧" , "Tui ki daka off korbi na👹🤬?" , "Gali Sunna H kya? 🤬" , "Mujhe Aapse Baat nhi karni" , "Aree Bandh kar Bandh Kar💩" , "tore latti dimu🙊🙊. kew ai pagol ke atkau😑" , "Ariyan ar kono kaj nei😾? Saradin bot bot koro😾😾" , " Amar boss 𝗠𝗔𝗛𝗜𝗠 ase kintu tmr bon ke vaigga nia jabe 🙀😐" , "Kuch Toh Saram karo🙊" , "Tui ki manan harate chas💫?" , "ai bar bolcis ar bolbi na👀" , "ami bot na ami tomar sona👀" , "I love u bolo kew dekhbe na 👀🙄" , "iss ami more jabo sona dakco to aibar kiss koro🤳🧠 😝" , "Dur Hat Be amar ki ar kono kaj nai sara din tor kace thakbo😂" , "Are Bolo Meri Jaan Kya Hall Hai😚 " , "sona buke aso🙈😋" , "Mujhe Mat BuLao Naw Main buSy h0o☝️" , "Bot Bolke Bejjti Kar Rahe ho l...Main To Tumhare Dil Ki Dhadkan Hu Baby...💔🥺" , "Are Tum Wahi ho nah Jisko Main Nahi Janta 🤪" , "Kal amar bed room a ai tui 😈" , "Sona dako kn 😏" , "sona aho🙈" , "bolun jahapana😒" , "Bar bar dakso ato valobasho amake 😜" , "Main T0o AnDha Hun 😎" , "Phle NaHa kRr Aa 😂" , "oak thuuuuuuu 😂😂😂" , "ami cole asci ki hoice sweetheart💞💙💚💛‎ ," , " Tor ar kono kaj nai? Sara din bot bot koris😼" , "Chup Karo jara😤 nahole baire asse tor dat vangbo😈" , "𝗠𝗔𝗛𝗜𝗠 boss jinda bad🙊 ", "মারহাবা Irfan দিলেন ৫০০ টাকা😑😑 Irfan দান করেছেন ৫০০টাকা" , "ami kicu dekhte passi na🌚" , "Bot Na Bal 😢 JaNu Bolo😘 "];
  var rand = tl[Math.floor(Math.random() * tl.length)]

    if ((event.body.toLowerCase() == "love bot") || (event.body.toLowerCase() == "love bot")) {
     return api.sendMessage("amak na amat boss 𝗠𝗔𝗛𝗜𝗠 k valobasho :))", threadID);
   };
