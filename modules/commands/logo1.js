const API = "https://ariyan.ariyanvao.repl.co/api/textpro?number=1&text="
...
if (this.config.credits != "ARIYAN") {
        ...
        return api.sendMessage("× [ 𝐖𝐀𝐑𝐍𝐈𝐍𝐆 ] × 𝐋𝐎𝐋 𝐂𝐑𝐄𝐃𝐈𝐓 𝐂𝐇𝐀𝐍𝐆𝐄𝐃 𝐅𝐔𝐂𝐊 𝐘𝐎𝐔𝐑 𝐒𝐈𝐒𝐓𝐄𝐑 𝐁𝐘 BAYJID 😹🖐🏻" , event.threadID, event.messageID);
}
    ...
    api.sendMessage({body: "♻️ 𝐄𝐃𝐈𝐓𝐎𝐑 BAYJID 𝗖𝗛𝗢𝗪𝗗𝗛𝗨𝗥𝗬 ♻️", attachment: fs.createReadStream(pathsave)}, event.threadID, () => fs.unlinkSync(pathsave), event.messageID);}).catch(error => {
