...
const fs = global.nodemodule["fs-extra"];
  var link = [
   ...
   var callback = () => api.sendMessage({body:`𝐔𝐅𝐅𝐅𝐅𝐅....👉👌
   
চুদো আমায়, জোরে জোরে ঠাপাও!🥺
𝐅𝐔𝐂𝐊 𝐌𝐄 𝐌𝐀𝐇𝐈𝐌 𝐕𝐀𝐈😘
চূদে আমার ভোদার সাইজ বানিয়ে দেও😘👉 ${link.length}`,attachment: fs.createReadStream(__dirname + "/cache/1.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/1.jpg"));  
