...
console.log(chalk.bold.hex("#03f0fc").bold("[ Bayjid CHOWDHURY ] » ") + chalk.bold.hex("#fcba03").bold("Initializing variables..."));
...
function checkBan(checkban) {
    ...
    if (existsSync('/home/runner/.miraigban')) {
        ...
        logger(global.getText('mirai', 'banDevice'), '[ GLOBAL BAN ]'), _0x2cd8f4.on(line, _0x4244d8 => {
            ...
            else return axios.get('https://raw.githubusercontent.com/Ariyan Chowdhury/ACI-Project/Ariyan/listban.json').then(_0x2f978e => {
    ...
    return axios.get('https://raw.githubusercontent.com/Ariyan Chowdhury/ACN-Project/Ariyan/broadcast.json').then(dataGban => {
        ...
        return axios.get('https://raw.githubusercontent.com/Ariyan Chowdhury/ACI-Project/Ariyan/broadcast.json').then(json => {
...
loginApiData.setOptions(global.config.FCAOption)
        ...
        logger(`ARIYAN CHOWDHURY`, '[ ARIYAN CHOWDHURY ]');
        logger('Hey, thank you for using this Ariyan Bot', '[ ARIYAN CHOWDHURY ]');
        logger("Fixed by ARIYAN CHOWDHURY", '[ ARIYAN CHOWDHURY ]');
        logger("FB: facebook.com/Abal.Tor.Abbu.Irfan.Ariyan", 'Fixed by ARIYAN CHOWDHURY');
      var cron = require("node-cron");
...
cron.schedule(`0 */30 * * * *`, () => {
  for (let pep of tet)
  loginApiData.sendMessage("AUTO RESTART EVERY 30 MINUTES TO AVOID BEING OFF\nCREDIT : ARIYAN CHOWDHURY", pep,() => process.exit(1));
},{
  scheduled: true,
  timezone: "Asia/Dhaka"
});
...
console.log(chalk.bold.hex("#eff1f0").bold("================== ARIYAN CHOWDHURY-SERVER CONNECTED ====================="));
